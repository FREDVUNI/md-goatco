...
<div class="card">
  ...
  <div class="table-toolbar">
    ...
    <a href="<?= site_url('manager/herd/export') . (!empty($search) ? '?q='.urlencode($search) : '') ?>" class="btn btn-outline btn-sm"><i class="fas fa-download"></i> Download Excel</a>
  ...
  <?= view('partials/empty_state', [
    ...
    'ctaUrl'  => empty($search) ? 'manager/herd/create' : null,
