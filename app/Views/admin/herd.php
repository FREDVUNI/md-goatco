...
<div class="card">
  ...
  <div class="table-toolbar">
    ...
    <a href="<?= site_url('admin/herd/export') . (!empty($search) ? '?q='.urlencode($search) : '') ?>" class="btn btn-outline btn-sm"><i class="fas fa-download"></i> Download Excel</a>
    <?= view('partials/import_widget', ['importAction' => 'admin/herd/import', 'importHint' => 'tag_number, name, breed, sex (male/female), dob (YYYY-MM-DD), pen_id, member_email, notes']) ?>
  </div>
