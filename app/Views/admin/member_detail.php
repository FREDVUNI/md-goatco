...
<a href="<?= site_url('admin/members') ?>" class="back-link"><i class="fas fa-arrow-left"></i> Back to members</a>
<div class="card">
  ...
  <div style="padding:6px 22px 4px">
    ...
    <div class="profile-row"><label><?= esc($k) ?></label><span><?= esc($v) ?></span></div>
    <?php endforeach ?>
  </div>
</div>
<?php if (!empty($goats)): ?>
