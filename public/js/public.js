...
(function () {
  ...
  counter.style.cssText = 'font-size:0.74rem;color:var(--slate-light);text-align:right;margin-top:4px;';
  ...
  const update = () => {
    ...
    counter.style.color = len > max * 0.9 ? 'var(--amber)' : 'var(--slate-light)';
  };
